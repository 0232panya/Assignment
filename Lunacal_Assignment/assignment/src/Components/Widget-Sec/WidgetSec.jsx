...
const WidgetSec = () => {
  ...
  return (
    <div className='widget-sec'>
        ...
        <div className='W-middle-Sec'>
            <div className='middle-topSec'>
                {/* <ul> */}
                    <button className={activeBTN === 'aboutme' ? 'widget-btn active' : 'widget-btn'} onClick={() => setActiveBTN('aboutme')}>About Me</button>
                    <button className={activeBTN === 'exp' ? 'widget-btn active' : 'widget-btn'} onClick={() => setActiveBTN('exp')}>Experiences</button>
                    <button className={activeBTN === 'recommend' ? 'widget-btn active' : 'widget-btn'} onClick={() => setActiveBTN('recommend')}>Recommended</button>
